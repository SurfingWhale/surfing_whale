// app/components/HoldButton/HoldButton.tsx
//
// Vendored from React Bits (Micro), MIT. Copied rather than installed, the
// same way GooeyNav and the others here were: it is one file with no runtime
// dependency, and a copy can be read and changed without a lockfile entry.
//
// Used on the one action in the studio that cannot be taken back. Approving
// a request sends a stranger a key by email; there is no undo for an email.
// A button that has to be held is not decoration there — it is the pause
// between meaning to do something and having done it.
//
// Changed from the original: "use client", because everything under app/ is
// a server component until it says otherwise.
